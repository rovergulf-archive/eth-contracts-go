...
func (_Erc721Extensions *Erc721ExtensionsCaller) TokenByIndex(opts *bind.CallOpts, index *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Erc721Extensions.contract.Call(opts, &out, "tokenByIndex", index)
...
//
// Solidity: function tokenByIndex(uint256 index) view returns(uint256)
func (_Erc721Extensions *Erc721ExtensionsSession) TokenByIndex(index *big.Int) (*big.Int, error) {
	return _Erc721Extensions.Contract.TokenByIndex(&_Erc721Extensions.CallOpts, index)
}

// TokenByIndex is a free data retrieval call binding the contract method 0x4f6ccce7.
//
// Solidity: function tokenByIndex(uint256 index) view returns(uint256)
func (_Erc721Extensions *Erc721ExtensionsCallerSession) TokenByIndex(index *big.Int) (*big.Int, error) {
	return _Erc721Extensions.Contract.TokenByIndex(&_Erc721Extensions.CallOpts, index)
}
...
func (_Erc721Extensions *Erc721ExtensionsCaller) TokenOfOwnerByIndex(opts *bind.CallOpts, owner common.Address, index *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Erc721Extensions.contract.Call(opts, &out, "tokenOfOwnerByIndex", owner, index)
...
//
// Solidity: function tokenOfOwnerByIndex(address owner, uint256 index) view returns(uint256)
func (_Erc721Extensions *Erc721ExtensionsSession) TokenOfOwnerByIndex(owner common.Address, index *big.Int) (*big.Int, error) {
	return _Erc721Extensions.Contract.TokenOfOwnerByIndex(&_Erc721Extensions.CallOpts, owner, index)
}

// TokenOfOwnerByIndex is a free data retrieval call binding the contract method 0x2f745c59.
//
// Solidity: function tokenOfOwnerByIndex(address owner, uint256 index) view returns(uint256)
func (_Erc721Extensions *Erc721ExtensionsCallerSession) TokenOfOwnerByIndex(owner common.Address, index *big.Int) (*big.Int, error) {
	return _Erc721Extensions.Contract.TokenOfOwnerByIndex(&_Erc721Extensions.CallOpts, owner, index)
}
...
func (_Erc721Extensions *Erc721ExtensionsCaller) TotalSupply(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Erc721Extensions.contract.Call(opts, &out, "totalSupply")
...
//
// Solidity: function totalSupply() view returns(uint256)
func (_Erc721Extensions *Erc721ExtensionsSession) TotalSupply() (*big.Int, error) {
	return _Erc721Extensions.Contract.TotalSupply(&_Erc721Extensions.CallOpts)
}

// TotalSupply is a free data retrieval call binding the contract method 0x18160ddd.
//
// Solidity: function totalSupply() view returns(uint256)
func (_Erc721Extensions *Erc721ExtensionsCallerSession) TotalSupply() (*big.Int, error) {
	return _Erc721Extensions.Contract.TotalSupply(&_Erc721Extensions.CallOpts)
}
...
func (_Erc721Extensions *Erc721ExtensionsTransactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) (*types.Transaction, error) {
	return _Erc721Extensions.contract.Transact(opts, "setApprovalForAll", operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_Erc721Extensions *Erc721ExtensionsSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _Erc721Extensions.Contract.SetApprovalForAll(&_Erc721Extensions.TransactOpts, operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_Erc721Extensions *Erc721ExtensionsTransactorSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _Erc721Extensions.Contract.SetApprovalForAll(&_Erc721Extensions.TransactOpts, operator, approved)
}
