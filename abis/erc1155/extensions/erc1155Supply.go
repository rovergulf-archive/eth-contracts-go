...
func (_Erc1155Extensions *Erc1155ExtensionsCaller) Exists(opts *bind.CallOpts, id *big.Int) (bool, error) {
	var out []interface{}
	err := _Erc1155Extensions.contract.Call(opts, &out, "exists", id)
...
//
// Solidity: function exists(uint256 id) view returns(bool)
func (_Erc1155Extensions *Erc1155ExtensionsSession) Exists(id *big.Int) (bool, error) {
	return _Erc1155Extensions.Contract.Exists(&_Erc1155Extensions.CallOpts, id)
}

// Exists is a free data retrieval call binding the contract method 0x4f558e79.
//
// Solidity: function exists(uint256 id) view returns(bool)
func (_Erc1155Extensions *Erc1155ExtensionsCallerSession) Exists(id *big.Int) (bool, error) {
	return _Erc1155Extensions.Contract.Exists(&_Erc1155Extensions.CallOpts, id)
}
...
func (_Erc1155Extensions *Erc1155ExtensionsCaller) TotalSupply(opts *bind.CallOpts, id *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Erc1155Extensions.contract.Call(opts, &out, "totalSupply", id)
...
//
// Solidity: function totalSupply(uint256 id) view returns(uint256)
func (_Erc1155Extensions *Erc1155ExtensionsSession) TotalSupply(id *big.Int) (*big.Int, error) {
	return _Erc1155Extensions.Contract.TotalSupply(&_Erc1155Extensions.CallOpts, id)
}

// TotalSupply is a free data retrieval call binding the contract method 0xbd85b039.
//
// Solidity: function totalSupply(uint256 id) view returns(uint256)
func (_Erc1155Extensions *Erc1155ExtensionsCallerSession) TotalSupply(id *big.Int) (*big.Int, error) {
	return _Erc1155Extensions.Contract.TotalSupply(&_Erc1155Extensions.CallOpts, id)
}
...
func (_Erc1155Extensions *Erc1155ExtensionsCaller) Uri(opts *bind.CallOpts, arg0 *big.Int) (string, error) {
	var out []interface{}
	err := _Erc1155Extensions.contract.Call(opts, &out, "uri", arg0)
...
//
// Solidity: function uri(uint256 ) view returns(string)
func (_Erc1155Extensions *Erc1155ExtensionsSession) Uri(arg0 *big.Int) (string, error) {
	return _Erc1155Extensions.Contract.Uri(&_Erc1155Extensions.CallOpts, arg0)
}

// Uri is a free data retrieval call binding the contract method 0x0e89341c.
//
// Solidity: function uri(uint256 ) view returns(string)
func (_Erc1155Extensions *Erc1155ExtensionsCallerSession) Uri(arg0 *big.Int) (string, error) {
	return _Erc1155Extensions.Contract.Uri(&_Erc1155Extensions.CallOpts, arg0)
}
